...
import { TOKEN_PROGRAM_ID, 
  ...
  createInitializeMintInstruction, MINT_SIZE } 
...
describe('mint-nft', () => {
  ...
  const program = anchor.workspace.MarketSol as Program<MarketSol>

  it("Do mint NFT", async () => {
    // Add your test here.
    ...
    console.log("New token address: ", mintKey.publicKey.toString());
